...
$(function () {
    ...
    //详情信息点击
    $(".manage-history .group-detail-btn").click(function () {
        ...
        $.post(
            Home + "Ajax/getGroupById", {
                ...
                console.log(data);
                var str = '<div class="row group-head"><div class="col-xs-6 text-left"><b>#' + data['group_no'] + '</b>&nbsp;&nbsp;' + data['date'] + '</div><div class="col-xs-6 text-right">';
                switch (data['status']) {
                    case "-1":
                        str += '订单已删除';
                        break;
                ...
                $("#groupDetail .history-body").html(str);
            }
        );
