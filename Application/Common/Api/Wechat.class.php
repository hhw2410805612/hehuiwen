...
//        );
        ...
        //传入参数
//        $info = array(
//            'body' => $need_info['body'],//商品名
//            'attach' => $need_info['attach'],//设置附加数据
//            'out_trade_no' => $need_info['order_index'],//订单号
//            'total_fee' => $need_info['order_money'],
//            'time_start' => date("YmdHis"),//请求发起时间
//            'time_expire' => date("YmdHis", time() + 600),//请求结束时间
//            'goods_tag' => 'test',//设置货物优惠劵
//            'notify_url' => $need_info['notify_url'],//异步通知页面url
//            'openid' => $need_info['openid'],//用户openid
//        );
