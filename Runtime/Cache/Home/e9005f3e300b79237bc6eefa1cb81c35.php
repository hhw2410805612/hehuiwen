...
<body>
    ...
    <div class="shop-index">
        ...
        <div class="container padding-none fl">
            <img style="width: 100%" src="/Public/Home/images/shop_top_bg.jpg"/>
        </div>
        <div>
            <marquee><span style="color:red;font-size: 15px;">校外起送价为10元，低于10元多加一元配送费</span></marquee>
        </div>
        <!--商品种类-->
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-3 text-center feature-icon" classify-id="7">
                            <img class="img-circle center-block" src="/Public/Home/images/shop_icon/shop_index_1.jpg"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-3 text-center feature-icon" classify-id="8">
                            <img class="img-circle center-block" src="/Public/Home/images/shop_icon/shop_index_2.jpg"/>
    ...
    <script type="text/javascript" src="/Public/Home/js/shop/shop.index.js"></script>
