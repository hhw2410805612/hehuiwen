...
<body>
            ...
            <?php if(!empty($orderList)): if(is_array($orderList)): $i = 0; $__LIST__ = $orderList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="container detail" goods-id="<?php echo ($vo["goods_group_id"]); ?>" shop-id="<?php echo ($vo["shop"]["shop_id"]); ?>">
                        ...
                        <div class="row money">
                            <div class="col-xs-12 text-right">
                                共2件商品,实付<span class="number">￥<?php echo ($vo["money"]); ?></span>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <a href="<?php echo U('order');?>">
                    <div class="col-xs-4 text-center">
                        <img class="img-circle center-block" src="/Public/Home/images/shop_icon/shop_order_fill.png"/>
    ...
    <script type="text/javascript" src="/Public/Home/js/shop/shop.order.js"></script>
