        ...
        <form action="<?php echo U('edit');?>" method="post">
            ...
            <div class="container body">
                <div class="row">
                    ...
                    <div class="col-xs-9">
                        <input name="name" placeholder="请填写收货人姓名" value="<?php echo ($address["name"]); ?>" autocomplete="off"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-3">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-9">
                        <input type="number" name="tell" value="<?php echo ($address["tell"]); ?>" placeholder="请填写收货手机号" autocomplete="off" maxlength="11"/>
                    </div>
                </div>
            </div>
            ...
            <div class="container body">
                <div class="row">
                    <div class="col-xs-5">
                        <span class="edit-label text-ellipsis">小区/大厦/学校</span>
                    </div>
                    <div class="col-xs-7">
                        <input name="site" placeholder="例:宜宾学院" value="<?php echo ($address["site"]); ?>" autocomplete="off"/>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-5">
                    ...
                    <div class="col-xs-7">
                        <input name="xxsite" placeholder="例:13舍515寝室" value="<?php echo ($address["xxsite"]); ?>" autocomplete="off"/>
                    </div>
                </div>
            </div>
