...
<body>
    ...
    <div class="order-manage">
        ...
        <div class="manage-banner">
            <ul>
                <li class="loid selected" group-status="0">未确认</li>
                <li class="loid" group-status="1">已确认</li>
                <li class="loid" group-status="2">配送中</li>
                <li class="loid" group-status="3">已完成</li>
                <li class="loid" group-status="-1">已取消</li>
            </ul>
        </div>
                        ...
                        <div class="container commodity">
                            ...
                            <div class="row sure-box">
                                <div class="col-xs-12 text-right">
                                    <button class="btn btn-default cancel" group-id="<?php echo ($vo["goods_group_id"]); ?>">不接此单</button>
                                    <button class="btn btn-primary sure" group-id="<?php echo ($vo["goods_group_id"]); ?>">确认订单</button>
                                </div>
                            </div>
                        </div>
                    </div><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <script type="text/javascript" src="/Public/Home/js/manage/manage.order.js"></script>
